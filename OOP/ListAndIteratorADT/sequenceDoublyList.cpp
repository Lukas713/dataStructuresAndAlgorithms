...
#include <algorithm>
/*
Sequence doubly list is kinda same as doubly linked list with iteration.
Only difference is that sequence have two more functions that returns index of position indexOf() - worst scenario O(n)
and return position on some index atIndex() worst scenario O(n)
*/
